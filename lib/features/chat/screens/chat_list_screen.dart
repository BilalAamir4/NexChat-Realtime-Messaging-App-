...
class _ChatListScreenState extends ConsumerState<ChatListScreen>
    ...
    return Row(
      ...
      children: List.generate(3, (i) {
        return AnimatedContainer(
          ...
          decoration: const BoxDecoration(color: NexColors.indigo, shape: BoxShape.circle),
        );
      }),
    );
  }

  Widget _buildPreviewBubble(String text, {bool isSent = false, bool isTyping = false}) {
    return Align(
  ...
  Widget _buildAvatar({double radius = 24, String? photoUrl, String? name, bool isGroup = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: NexColors.indigo.withValues(alpha: 0.25), blurRadius: 10, offset: const Offset(0, 3))],
      ),
  ...
  Widget _buildChatItem(ChatModel chat, String name, String photoUrl) {
    ...
    return InkWell(
      ...
      onTap: () => Navigator.pushNamed(context, AppRoutes.chatRoom, arguments: {
        'chatId':          chat.chatId,
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          ...
          children: [
            _buildAvatar(radius: 24, photoUrl: photoUrl, name: name, isGroup: isGroup),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: context.textPrimary, letterSpacing: -0.2),
                      ),
                      Container(
                        ...
                        child: Text(timeStr, style: TextStyle(color: context.textMuted, fontSize: 11, fontWeight: FontWeight.w500)),
                      ),
                    ],
                  ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(colors: [NexColors.violet, NexColors.indigo],
                              begin: Alignment.topLeft, end: Alignment.bottomRight),
                          borderRadius: BorderRadius.circular(20),
                          boxShadow: [BoxShadow(color: NexColors.violet.withValues(alpha: 0.4), blurRadius: 8, offset: const Offset(0, 2))],
                        ),
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.search, color: NexColors.indigo),
                        filled: true,
                        fillColor: context.isDark ? NexColors.darkSurface : NexColors.lightCardSurface,
  ...
  Widget _buildSearchResult(String name) {
    return ListTile(
      ...
      title: Text(name, style: TextStyle(color: context.textPrimary, fontWeight: FontWeight.w600, fontSize: 14)),
      subtitle: Text('Tap to open chat', style: TextStyle(color: context.textMuted, fontSize: 12)),
    ...
    return Scaffold(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    Container(width: 8, height: 8, decoration: const BoxDecoration(color: NexColors.indigo200, shape: BoxShape.circle)),
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: context.cardBorder, width: 1),
          boxShadow: [BoxShadow(color: NexColors.indigo.withValues(alpha: 0.1), blurRadius: 28, offset: const Offset(0, 10))],
        ),
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  if (widget.filter != ChatType.direct) Navigator.pushReplacementNamed(context, AppRoutes.chat);
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.chat_bubble_rounded,
                        color: !isGroupsScreen ? NexColors.indigo : context.textMuted, size: 22),
                    const SizedBox(height: 3),
                    Container(width: 4, height: 4,
                        decoration: BoxDecoration(
                            color: !isGroupsScreen ? NexColors.indigo : Colors.transparent,
                            shape: BoxShape.circle)),
                  ],
                ),
              ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const LinearGradient(colors: [NexColors.indigo, NexColors.violet],
                        begin: Alignment.topLeft, end: Alignment.bottomRight),
                    boxShadow: [BoxShadow(color: NexColors.violet.withValues(alpha: 0.4), blurRadius: 16, offset: const Offset(0, 4))],
                  ),
              ...
              GestureDetector(
                onTap: () {
                  if (widget.filter != ChatType.group) Navigator.pushReplacementNamed(context, AppRoutes.groups);
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
            ...
            children: [
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(_title,
                                style: TextStyle(color: context.textPrimary, fontWeight: FontWeight.w800, fontSize: 22, letterSpacing: -0.5)),
                ...
                data: (chats) {
                  ...
                  return Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(isGroupsScreen ? 'Your Groups' : 'Recent',
                            style: TextStyle(color: context.textSecondary, fontSize: 13, fontWeight: FontWeight.w600, letterSpacing: 0.5)),
                        Text('${filtered.length} ${isGroupsScreen ? 'group' : 'conversation'}${filtered.length == 1 ? '' : 's'}',
              ...
              Expanded(
                child: chatsAsync.when(
                  ...
                  error: (e, st) => Center(child: Text('Could not load chats', style: TextStyle(color: context.textMuted))),
                  data: (chats) {
                    final filtered = widget.filter == null
                        ? chats
                        : chats.where((c) => c.type == widget.filter).toList();
                    ...
                    if (filtered.isEmpty) {
                      return Center(
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(isGroupsScreen ? Icons.group_outlined : Icons.chat_bubble_outline_rounded,
                                size: 56, color: context.cardBorder),
                            const SizedBox(height: 16),
                            Text(_emptyMessage,
                                style: TextStyle(color: context.textPrimary, fontSize: 16, fontWeight: FontWeight.w600)),
                            const SizedBox(height: 6),
                            Text(_emptySubMessage, style: TextStyle(color: context.textMuted, fontSize: 13)),
                          ],
                        ),
                      );
                    }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (chat.type == ChatType.group) {
                          return _buildChatItem(chat, chat.groupName ?? 'Group', '');
                        }
