...
class _RadarScreenState extends ConsumerState<RadarScreen>
  ...
  Future<void> _search(String query) async {
    ...
    final byUsername = await FirebaseFirestore.instance
        .collection('users').where('username', isEqualTo: q).get();
    ...
    if (mounted) {
      ...
      if (merged.isNotEmpty) {
        _sheetController.animateTo(_expandedSize,
  ...
  Future<void> _startChat(UserModel user) async {
    final chatId = await ref.read(chatServiceProvider).getOrCreateDirectChat(user.uid);
    if (!mounted) return;
    ...
    return Positioned(
      ...
      child: GestureDetector(
        onTap: () => setState(() {
          ...
          _searchCtrl.clear();
          _searchResults = [];
          _sheetController.animateTo(_collapsedSize,
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: NexColors.indigo.withValues(alpha: isSelected ? 0.65 : 0.3),
          ...
          child: ru.user.photoUrl.isNotEmpty
              ? ClipOval(child: Image.network(ru.user.photoUrl, fit: BoxFit.cover))
              : Center(
            child: Text(
              ru.user.displayName.isNotEmpty ? ru.user.displayName[0].toUpperCase() : '?',
      ...
      child: Material(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: NexColors.indigo.withValues(alpha: 0.18), blurRadius: 24, offset: const Offset(0, 8)),
            ],
          ),
          child: Row(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Text(user.displayName,
                        style: const TextStyle(color: NexColors.lightSlateDark,
                            fontWeight: FontWeight.w700, fontSize: 15, letterSpacing: -0.2)),
                    Text('@${user.username}',
                        style: const TextStyle(color: NexColors.lightSlateMuted, fontSize: 12)),
                  ],
                ),
              ),
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(shape: BoxShape.circle, color: NexColors.indigo100),
                  child: const Icon(Icons.close_rounded, size: 16, color: NexColors.indigo),
                ),
              ),
              GestureDetector(
      ...
      builder: (context, scrollController) {
        return Container(
          decoration: BoxDecoration(
            ...
            border: Border(top: BorderSide(color: NexColors.indigo200.withValues(alpha: 0.25), width: 1)),
            boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.4), blurRadius: 30, offset: const Offset(0, -6))],
          ),
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              onChanged: (val) {
                                if (_selectedRadar != null) setState(() => _selectedRadar = null);
                              },
                              onSubmitted: _search,
                              decoration: InputDecoration(
                                hintText: 'Search by name or @username...',
                                hintStyle: TextStyle(color: NexColors.indigo200.withValues(alpha: 0.5), fontSize: 13),
                                filled: true,
                                fillColor: NexColors.indigo.withValues(alpha: 0.15),
                                prefixIcon: Icon(Icons.search_rounded,
                                    color: NexColors.indigo200.withValues(alpha: 0.7), size: 20),
                                contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(24),
                                  borderSide: BorderSide(color: NexColors.indigo200.withValues(alpha: 0.25), width: 1),
                                ),
                          ...
                          GestureDetector(
                            onTap: _searching ? null : () => _search(_searchCtrl.text),
                            child: Container(
                              width: 44, height: 44,
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                        ...
                        child: Row(
                          children: [
                            Text(
                              ...
                              style: TextStyle(color: NexColors.indigo200.withValues(alpha: 0.7),
                            ...
                            GestureDetector(
                              ...
                              child: Text('Clear',
                                  style: TextStyle(color: NexColors.indigo200.withValues(alpha: 0.5), fontSize: 12)),
                            ),
                          ],
                        ),
                      ),
                    if (_searchResults.isEmpty && !_searching)
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: NexColors.indigo200.withValues(alpha: 0.4),
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: NexColors.indigo200.withValues(alpha: 0.15), width: 1),
                        ),
                        child: Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(colors: [NexColors.indigo, NexColors.violet],
                                    begin: Alignment.topLeft, end: Alignment.bottomRight),
                                border: Border.all(color: NexColors.indigo200.withValues(alpha: 0.4), width: 1.5),
                              ),
                              child: user.photoUrl.isNotEmpty
                                  ? ClipOval(child: Image.network(user.photoUrl, fit: BoxFit.cover))
                                  : Center(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('@${user.username}',
                                      style: TextStyle(color: NexColors.indigo200.withValues(alpha: 0.6), fontSize: 12)),
                                ],
                              ),
                            ),
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: const LinearGradient(colors: [NexColors.indigo, NexColors.violet]),
                                  borderRadius: BorderRadius.circular(16),
                                  boxShadow: [BoxShadow(color: NexColors.violet.withValues(alpha: 0.35), blurRadius: 8, offset: const Offset(0, 2))],
                                ),
                                child: const Text('Chat',
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF080720), Color(0xFF1E1B4B), Color(0xFF2D1B69)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
                stops: [0.0, 0.55, 1.0],
              ),
          ...
          Positioned(
            left: center.dx - radarR, top: center.dy - radarR,
            width: radarR * 2, height: radarR * 2,
            child: AnimatedBuilder(
              animation: Listenable.merge([_sweepCtrl, _pulseCtrl]),
              builder: (_, __) => CustomPaint(
                painter: _RadarPainter(sweep: _sweepCtrl.value, pulse: _pulseCtrl.value, radius: radarR),
              ),
            ),
          ),
          ...
          SafeArea(
            child: Padding(
              ...
              child: Row(
                children: [
                  IconButton(
                    icon: const Icon(Icons.arrow_back_ios_new_rounded, color: NexColors.indigo200, size: 20),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(color: NexColors.indigo200.withValues(alpha: 0.4), width: 1),
                    ),
                    child: Text(
                      _loading ? '...' : '${_allUsers.length} users',
                      style: const TextStyle(color: NexColors.indigo200, fontSize: 12, fontWeight: FontWeight.w600),
                    ),
                  ),
...
class _RadarPainter extends CustomPainter {
  ...
  const _RadarPainter({required this.sweep, required this.pulse, required this.radius});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 1; i <= 4; i++) {
      ...
      canvas.drawCircle(center, r + pulseBump,
          Paint()
            ..color = NexColors.indigo200.withValues(alpha: 0.12 + (i == 1 ? 0.04 : 0))
            ..style = PaintingStyle.stroke
            ..strokeWidth = i == 1 ? 0.8 : 0.5);
    }

    final crossPaint = Paint()..color = NexColors.indigo200.withValues(alpha: 0.1)..strokeWidth = 0.5;
    ...
    canvas.drawLine(Offset.zero, Offset(radius, 0),
        Paint()
    ...
    canvas.drawCircle(center, 5,
        Paint()
          ..shader = const LinearGradient(colors: [NexColors.indigo, NexColors.violet])
              .createShader(Rect.fromCircle(center: center, radius: 5)));
    canvas.drawCircle(center, 2.5, Paint()..color = Colors.white);
  }

  @override
  bool shouldRepaint(covariant _RadarPainter old) => old.sweep != sweep || old.pulse != pulse;
}